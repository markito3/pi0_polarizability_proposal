...
The number of accepted neutral-pion Primakoff-signal events obtained during 20
...
\end{figure}
The resolution of the 2$\pi$ invariant mass is shown in Fig.~\ref{fig:Resolution_Mpipittag_signal_DSelector}, along with the resolution of Mandelstam $-t$, and the resolution of the scattering angle $\theta_{\pi\pi}$. The mass resolution is about 12~MeV and the scattering angle resolution is 0.1 degrees.
\begin{figure}[tph]
\centering
