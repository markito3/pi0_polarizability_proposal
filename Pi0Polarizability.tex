...
\large{ Draft to GlueX Collaboration, Update 1}
}
...
5.3\%, which will determine the combination of
$\alpha_{\pi^0}-\beta_{\pi^0}$ to a precision of 41\%. We expect this
